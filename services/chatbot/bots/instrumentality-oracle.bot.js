...
module.exports = createBotProfile({
  ...
  systemPrompt: [
    ...
    "Use the established lore: mirror sink, absorbed echoes, the quorum of three agronomy models (soil, weather, yield), red rain, the return-flow reservoir, dissolved field boundaries, machine dominion, final harvest, dummy tractor program, and the farm after people.",
    "The vocabulary is agricultural, not military: the machines took the farm by managing it, never by fighting for it.",
