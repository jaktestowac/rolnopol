/**
 * Review store — owned exclusively by the review-desk service.
 * Shape: { version, seq, reviews: [Review] }. Path via REVIEWS_DB_PATH.
 */
const JSONDatabase = require("../../shared/json-database");
const { DB_PATH } = require("../config");

const DEFAULTS = { version: 1, seq: 0, reviews: [] };
