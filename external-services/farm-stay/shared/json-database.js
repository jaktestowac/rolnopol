/**
 * In-memory JSON store with file persistence for the FarmStay ecosystem.
 *
 ...
 * concurrent mutations (e.g. two bookings racing) are applied one at a time —
 * this is what makes the inventory service's check-and-lock atomic.
 */
