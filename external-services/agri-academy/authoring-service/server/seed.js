...
function buildSeed() {
  ...
  const demoExam = (id, title, description, questionCount, durationSec, accessWindowDays, passPct, certTemplate, difficulty, category) => ({
    id,
  ...
  return {
    ...
    units: {
      ...
      "unit-1": {
        ...
        description:
          "Farmer-led co-operative delivering practical certifications in soil health, nutrient management, and organic production.",
    ...
    exams: {
      ...
      "exam-5": exam(
        ...
        "Understanding soil structure, testing, organic matter, and balanced nutrient application.",
        6,
        1800,
        14,
        60,
      ...
      "exam-6": exam(
        ...
        "Standards, record-keeping, and prohibited inputs for certified organic crop production.",
        8,
        2400,
        30,
        75,
      ...
      "exam-7": exam(
        ...
        "Safe set-up, in-field operation, and settings for grain and oilseed harvesting.",
        7,
        2100,
        21,
        75,
      ...
      "exam-8": exam(
        ...
        "Routine servicing, lubrication, and pre-season checks for common farm machinery.",
        6,
        1500,
        14,
        70,
        ...
        "Machinery",
        { mode: "free", priceRol: 0 },
        "2026-05-03T14:10:00.000Z",
      ),
      "exam-9": exam(
        "exam-9",
        "unit-3",
        "Livestock Welfare & Handling",
        "Low-stress handling, the five freedoms, and recognising signs of ill health.",
        7,
        1800,
        21,
        70,
        ...
        "intermediate",
        "Livestock",
        { mode: "paid", priceRol: 30 },
        "2026-05-08T09:45:00.000Z",
      ),
      "exam-10": exam(
        "exam-10",
        "unit-3",
        "Dairy Hygiene & Milk Quality",
        "Milking routine, udder health, cleaning-in-place, and cold-chain basics.",
        6,
        1500,
        14,
        65,
      ...
      "exam-11": exam(
        ...
        "Timing, cut types, and shaping for healthy, productive fruit trees.",
        5,
        1200,
        14,
        60,
      ...
      "exam-12": exam(
        ...
        "Identifying and managing common vine pests and fungal diseases with an IPM approach.",
        6,
        1800,
        21,
        70,
